...
@section('content')
  ...
  <div class="contentpanel">
		<div class="panel panel-default">
			<form id="login_form" class="form-horizontal form-bordered" method="POST" action="/admin/industries/{{$data->id}}">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" name="industry_name" value="{{$data->industry_name}}" placeholder="名称"/>
            </div>
          </div>
          <div class="form-group">
