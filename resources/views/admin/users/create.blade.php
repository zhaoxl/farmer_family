...
@section('content')
  <div class="pageheader">
    <h2><i class="fa fa-envelope"></i> 用户 <span>添加用户</span></h2>
  </div>
			...
			<div class="col-md-13">
				<div class="panel panel-primary">
					<div class="panel-body panel-body-nopadding">
						...
						<form class="form-horizontal" id="register_form" role="form" method="POST" action="/admin/users">
							<input type="hidden" name="_token" value="{{ csrf_token() }}" />
							<input type="hidden" id="area_name" name="area_name" value="{{$data->area_name}}"/>
            
					            <div class="form-group">
											  <label for="disabledinput" class="col-sm-3 control-label">用户类型</label>
											  <div class="col-sm-6">
													<select name="category" id="category" size="1">
														<option value="0">个人用户</option>
														<option value="1">企业用户</option>
														<option value="2">个人雇人</option>
													</select>
											  </div>
											</div>
